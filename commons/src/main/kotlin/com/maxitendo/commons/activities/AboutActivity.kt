...
class AboutActivity : BaseComposeActivity() {
    ...
    private fun onPrivacyPolicyClick() {
        ...
        // For com.maxitendo.contacts, launch PrivacyPolicyActivity instead of web browser
        if (appId == "com.maxitendo.contacts") {
            try {
                val intent = Intent()
                ...
                // Fallback to web URL if activity not found
            }
        }

        val url = when (appId) {
            "com.maxitendo.dialer" -> "https://www.github.com/Maxitendo/about/privacy-policy-right-dialer"
            "com.maxitendo.smsmessenger" -> "https://www.github.com/Maxitendo/about/privacy-policy-right-messages"
            "com.maxitendo.contacts" -> "https://www.github.com/Maxitendo/about/privacy-policy-right-contacts"
            "com.maxitendo.gallery" -> "https://www.github.com/Maxitendo/about/privacy-policy-right-gallery"
            "com.maxitendo.filemanager" -> "https://www.github.com/Maxitendo/about/privacy-policy-right-files"
            "com.maxitendo.voicerecorder", "com.maxitendo.voicerecorderfree" -> "https://www.github.com/Maxitendo/about/privacy-policy-right-voice-recorder"
            "com.maxitendo.calendar" -> "https://www.github.com/Maxitendo/about/privacy-policy-right-calendar"
            else -> "https://www.github.com/Maxitendo/about/privacy-policy"
        }
