...
import com.maxitendo.commons.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import com.maxitendo.commons.models.AlarmSound
import com.maxitendo.commons.models.BlockedNumber
import com.maxitendo.commons.models.contacts.ContactRelation
...
fun Context.isBiometricAuthSupported(): Boolean = isBiometricIdAvailable()
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.maxitendo.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isOrWasThankYouInstalled(): Boolean {
    return when {
        ...
        isPackageInstalled("com.maxitendo.audiobook") -> true
        isPackageInstalled("com.maxitendo.voicerecorder") -> true
        isPackageInstalled("com.maxitendo.files") -> true
        else -> false
    }
}
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.maxitendo."))
...
fun Context.isDefaultDialer(): Boolean {
    val isDialerApp = packageName.startsWith("com.maxitendo.contacts") ||
                     packageName.startsWith("com.maxitendo.dialer") ||
                     packageName.startsWith("com.maxitendo.contacts")

    return if (!isDialerApp) {
        true
    } else if (isDialerApp && isQPlus()) {
...
fun Context.getRelationTypeText(type: Int, label: String): String {
    return if (type == BaseTypes.TYPE_CUSTOM) {
        ...
        getString(
            when (type) {
                // Relation.TYPE_CUSTOM   -> com.maxitendo.strings.R.string.custom
                Relation.TYPE_ASSISTANT   -> com.maxitendo.strings.R.string.relation_assistant_g
                Relation.TYPE_BROTHER     -> com.maxitendo.strings.R.string.relation_brother_g
                Relation.TYPE_CHILD       -> com.maxitendo.strings.R.string.relation_child_g
                Relation.TYPE_DOMESTIC_PARTNER -> com.maxitendo.strings.R.string.relation_domestic_partner_g
                Relation.TYPE_FATHER      -> com.maxitendo.strings.R.string.relation_father_g
                Relation.TYPE_FRIEND      -> com.maxitendo.strings.R.string.relation_friend_g
                Relation.TYPE_MANAGER     -> com.maxitendo.strings.R.string.relation_manager_g
                Relation.TYPE_MOTHER      -> com.maxitendo.strings.R.string.relation_mother_g
                Relation.TYPE_PARENT      -> com.maxitendo.strings.R.string.relation_parent_g
                Relation.TYPE_PARTNER     -> com.maxitendo.strings.R.string.relation_partner_g
                Relation.TYPE_REFERRED_BY -> com.maxitendo.strings.R.string.relation_referred_by_g
                Relation.TYPE_RELATIVE    -> com.maxitendo.strings.R.string.relation_relative_g
                Relation.TYPE_SISTER      -> com.maxitendo.strings.R.string.relation_sister_g
                Relation.TYPE_SPOUSE      -> com.maxitendo.strings.R.string.relation_spouse_g

                // Relation types defined in vCard 4.0
                ContactRelation.TYPE_CONTACT -> com.maxitendo.strings.R.string.relation_contact_g
                ContactRelation.TYPE_ACQUAINTANCE -> com.maxitendo.strings.R.string.relation_acquaintance_g
                // ContactRelation.TYPE_FRIEND -> com.maxitendo.strings.R.string.relation_friend
                ContactRelation.TYPE_MET -> com.maxitendo.strings.R.string.relation_met_g
                ContactRelation.TYPE_CO_WORKER -> com.maxitendo.strings.R.string.relation_co_worker_g
                ContactRelation.TYPE_COLLEAGUE -> com.maxitendo.strings.R.string.relation_colleague_g
                ContactRelation.TYPE_CO_RESIDENT -> com.maxitendo.strings.R.string.relation_co_resident_g
                ContactRelation.TYPE_NEIGHBOR -> com.maxitendo.strings.R.string.relation_neighbor_g
                // ContactRelation.TYPE_CHILD -> com.maxitendo.strings.R.string.relation_child
                // ContactRelation.TYPE_PARENT -> com.maxitendo.strings.R.string.relation_parent
                ContactRelation.TYPE_SIBLING -> com.maxitendo.strings.R.string.relation_sibling_g
                // ContactRelation.TYPE_SPOUSE -> com.maxitendo.strings.R.string.relation_spouse
                ContactRelation.TYPE_KIN -> com.maxitendo.strings.R.string.relation_kin_g
                ContactRelation.TYPE_MUSE -> com.maxitendo.strings.R.string.relation_muse_g
                ContactRelation.TYPE_CRUSH -> com.maxitendo.strings.R.string.relation_crush_g
                ContactRelation.TYPE_DATE -> com.maxitendo.strings.R.string.relation_date_g
                ContactRelation.TYPE_SWEETHEART -> com.maxitendo.strings.R.string.relation_sweetheart_g
                ContactRelation.TYPE_ME -> com.maxitendo.strings.R.string.relation_me_g
                ContactRelation.TYPE_AGENT -> com.maxitendo.strings.R.string.relation_agent_g
                ContactRelation.TYPE_EMERGENCY -> com.maxitendo.strings.R.string.relation_emergency_g

                ContactRelation.TYPE_SUPERIOR -> com.maxitendo.strings.R.string.relation_superior_g
                ContactRelation.TYPE_SUBORDINATE -> com.maxitendo.strings.R.string.relation_subordinate_g
                ContactRelation.TYPE_HUSBAND -> com.maxitendo.strings.R.string.relation_husband_g
                ContactRelation.TYPE_WIFE -> com.maxitendo.strings.R.string.relation_wife_g
                ContactRelation.TYPE_SON -> com.maxitendo.strings.R.string.relation_son_g
                ContactRelation.TYPE_DAUGHTER -> com.maxitendo.strings.R.string.relation_daughter_g
                ContactRelation.TYPE_GRANDPARENT -> com.maxitendo.strings.R.string.relation_grandparent_g
                ContactRelation.TYPE_GRANDFATHER -> com.maxitendo.strings.R.string.relation_grandfather_g
                ContactRelation.TYPE_GRANDMOTHER -> com.maxitendo.strings.R.string.relation_grandmother_g
                ContactRelation.TYPE_GRANDCHILD -> com.maxitendo.strings.R.string.relation_grandchild_g
                ContactRelation.TYPE_GRANDSON -> com.maxitendo.strings.R.string.relation_grandson_g
                ContactRelation.TYPE_GRANDDAUGHTER -> com.maxitendo.strings.R.string.relation_granddaughter_g
                ContactRelation.TYPE_UNCLE -> com.maxitendo.strings.R.string.relation_uncle_g
                ContactRelation.TYPE_AUNT -> com.maxitendo.strings.R.string.relation_aunt_g
                ContactRelation.TYPE_NEPHEW -> com.maxitendo.strings.R.string.relation_nephew_g
                ContactRelation.TYPE_NIECE -> com.maxitendo.strings.R.string.relation_niece_g
                ContactRelation.TYPE_FATHER_IN_LAW -> com.maxitendo.strings.R.string.relation_father_in_law_g
                ContactRelation.TYPE_MOTHER_IN_LAW -> com.maxitendo.strings.R.string.relation_mother_in_law_g
                ContactRelation.TYPE_SON_IN_LAW -> com.maxitendo.strings.R.string.relation_son_in_law_g
                ContactRelation.TYPE_DAUGHTER_IN_LAW -> com.maxitendo.strings.R.string.relation_daughter_in_law_g
                ContactRelation.TYPE_BROTHER_IN_LAW -> com.maxitendo.strings.R.string.relation_brother_in_law_g
                ContactRelation.TYPE_SISTER_IN_LAW -> com.maxitendo.strings.R.string.relation_sister_in_law_g
...
fun Context.isCollection(): Boolean {
    return isPackageInstalled("com.maxitendo.dialer")
        && isPackageInstalled("com.maxitendo.contacts")
        && isPackageInstalled("com.maxitendo.smsmessenger")
        && isPackageInstalled("com.maxitendo.gallery")
        && isPackageInstalled("com.maxitendo.audiobooklite")
        && isPackageInstalled("com.maxitendo.filemanager")
        && isPackageInstalled("com.maxitendo.keyboard")
        && isPackageInstalled("com.maxitendo.calendar")
        && isPackageInstalled("com.maxitendo.voicerecorderfree")
}
