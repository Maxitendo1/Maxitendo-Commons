...
import com.maxitendo.commons.activities.ManageBlockedNumbersActivity
...
import com.maxitendo.commons.compose.extensions.*
import com.maxitendo.commons.compose.theme.AppThemeSurface
import com.maxitendo.commons.dialogs.FilePickerDialog
import com.maxitendo.commons.dialogs.RateStarsAlertDialog
import com.maxitendo.commons.dialogs.SecurityDialog
import com.maxitendo.commons.extensions.*
import com.maxitendo.commons.helpers.LICENSE_AUTOFITTEXTVIEW
import com.maxitendo.commons.helpers.SHOW_ALL_TABS
import com.maxitendo.commons.models.FAQItem
import com.maxitendo.commons.samples.BuildConfig
import com.maxitendo.commons.samples.R
import com.maxitendo.commons.samples.screens.MainScreen
...
class MainActivity : BaseSimpleActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            AppThemeSurface {
                val showMoreApps = onEventValue { !resources.getBoolean(com.maxitendo.commons.R.bool.hide_google_relations) }
    ...
    private fun launchAbout() {
        ...
        val faqItems = arrayListOf(
            FAQItem(com.maxitendo.commons.R.string.faq_1_title_commons, com.maxitendo.commons.R.string.faq_1_text_commons),
            FAQItem(com.maxitendo.commons.R.string.faq_4_title_commons, com.maxitendo.commons.R.string.faq_4_text_commons)
        )

        if (!resources.getBoolean(com.maxitendo.commons.R.bool.hide_google_relations)) {
            faqItems.add(FAQItem(com.maxitendo.commons.R.string.faq_2_title_commons, com.maxitendo.commons.R.string.faq_2_text_commons))
            faqItems.add(FAQItem(com.maxitendo.commons.R.string.faq_6_title_commons, com.maxitendo.commons.R.string.faq_6_text_commons))
        }
