...
import com.maxitendo.commons.compose.screens.ManageBlockedNumbersScreen
import com.maxitendo.commons.compose.theme.AppThemeSurface
import com.maxitendo.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.maxitendo.commons.dialogs.ExportBlockedNumbersDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.maxitendo.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.maxitendo.dialer")) {
