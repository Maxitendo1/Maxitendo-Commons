...
import com.maxitendo.commons.extensions.contactsDB
import com.maxitendo.commons.extensions.getByteArray
import com.maxitendo.commons.extensions.getEmptyContact
import com.maxitendo.commons.models.SimpleContact
import com.maxitendo.commons.models.contacts.Contact
import com.maxitendo.commons.models.contacts.Group
import com.maxitendo.commons.models.contacts.LocalContact
import com.maxitendo.commons.models.contacts.Organization
    ...
    companion object {
        fun convertContactToSimpleContact(contact: Contact?, withPhoneNumbersOnly: Boolean): SimpleContact? {
            return if (contact == null || (withPhoneNumbersOnly && contact.phoneNumbers.isEmpty())) {
                ...
                SimpleContact(contact.id, contact.id, contact.getNameToDisplay(), contact.photoUri, contact.phoneNumbers, birthdays, anniversaries, company, jobPosition)
            }
        }
    }
}
