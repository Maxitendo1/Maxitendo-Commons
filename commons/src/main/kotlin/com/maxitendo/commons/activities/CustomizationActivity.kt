...
import com.maxitendo.commons.databinding.ActivityCustomizationBinding
import com.maxitendo.commons.dialogs.*
import com.maxitendo.commons.extensions.*
import com.maxitendo.commons.helpers.*
import com.maxitendo.commons.helpers.MyContentProvider.COL_ACCENT_COLOR
import com.maxitendo.commons.helpers.MyContentProvider.COL_APP_ICON_COLOR
import com.maxitendo.commons.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import com.maxitendo.commons.helpers.MyContentProvider.COL_PRIMARY_COLOR
import com.maxitendo.commons.helpers.MyContentProvider.COL_TEXT_COLOR
import com.maxitendo.commons.helpers.MyContentProvider.COL_THEME_TYPE
import com.maxitendo.commons.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import com.maxitendo.commons.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import com.maxitendo.commons.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import com.maxitendo.commons.helpers.NavigationIcon
import com.maxitendo.commons.helpers.SAVE_DISCARD_PROMPT_INTERVAL
import com.maxitendo.commons.helpers.isSPlus
import com.maxitendo.commons.models.GlobalConfig
import com.maxitendo.commons.models.MyTheme
import com.maxitendo.commons.models.RadioItem
import com.maxitendo.commons.models.isGlobalThemingEnabled
...
//        binding.applyToAll.setTextColor(primaryColor.getContrastColor())
        ...
        binding.customizationAppIconColorHolder.setOnClickListener {
            if (baseConfig.wasAppIconCustomizationWarningShown || !isProVersion()) {
                ...
                val message = resources.getString(com.maxitendo.strings.R.string.app_icon_color_shortcuts_warning_g) + "\n\n" +
                    resources.getString(com.maxitendo.strings.R.string.app_icon_color_warning_g)
                ConfirmationDialog(
                    activity = this,
                    message = message,
                    messageId = com.maxitendo.strings.R.string.app_icon_color_warning_g,
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.maxitendo.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
    ...
    private fun pickAppIconColor() {
        IconListDialog(
            ...
            descriptionId = resources.getString(com.maxitendo.strings.R.string.app_icon_color_shortcuts_warning_g) + "\n\n"
                + resources.getString(com.maxitendo.strings.R.string.app_icon_color_warning_g)
        ...
        when {
            ...
            canAccessGlobalConfig() -> {
                ...
                ConfirmationDialog(
                    activity = this,
                    message = "",
                    messageId = com.maxitendo.strings.R.string.global_theme_success_g,
                    positive = R.string.ok,
                    negative = 0,
                    callback = {}
                )
    ...
    private fun setupUseAccentColor() {
        binding.apply {
            ...
            customizationUseAccentColorFaq.setOnClickListener {
                ConfirmationDialog(this@CustomizationActivity, messageId = com.maxitendo.strings.R.string.use_accent_color_summary, positive = com.maxitendo.commons.R.string.ok, negative = 0) {}
            }
        }
    }
