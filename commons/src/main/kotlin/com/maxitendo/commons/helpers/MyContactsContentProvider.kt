...
import com.maxitendo.commons.extensions.getIntValue
import com.maxitendo.commons.extensions.getStringValue
import com.maxitendo.commons.models.PhoneNumber
import com.maxitendo.commons.models.SimpleContact
import com.maxitendo.commons.models.contacts.*
import androidx.core.net.toUri
import com.maxitendo.commons.extensions.getStringValueOrNull
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.maxitendo.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.maxitendo.dialer" && packageName != "com.maxitendo.smsmessenger" && packageName != "com.maxitendo.calendar") {
                return contacts
            }
        ...
        fun getContacts(context: Context, cursor: Cursor?): ArrayList<Contact> {
            ...
            val packageName = context.packageName.removeSuffix(".debug")
            if (packageName != "com.maxitendo.dialer" && packageName != "com.maxitendo.smsmessenger" && packageName != "com.maxitendo.calendar"
                && packageName != "com.maxitendo.dialer.debug" && packageName != "com.maxitendo.smsmessenger.debug" && packageName != "com.maxitendo.calendar.debug") {
                return contacts
            }
