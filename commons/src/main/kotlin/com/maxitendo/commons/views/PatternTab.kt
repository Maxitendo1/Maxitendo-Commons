...
import com.maxitendo.commons.databinding.TabPatternBinding
import com.maxitendo.commons.extensions.getProperPrimaryColor
import com.maxitendo.commons.extensions.getProperTextColor
import com.maxitendo.commons.extensions.performHapticFeedback
import com.maxitendo.commons.extensions.updateTextColors
import com.maxitendo.commons.helpers.PROTECTION_PATTERN
import com.maxitendo.commons.interfaces.BaseSecurityTab
...
class PatternTab(context: Context, attrs: AttributeSet) : BaseSecurityTab(context, attrs) {
    ...
    override fun initTab(
        ...
        if (computedHash != "") binding.patternLockTitle.setText(com.maxitendo.strings.R.string.enter_pattern)
    }
