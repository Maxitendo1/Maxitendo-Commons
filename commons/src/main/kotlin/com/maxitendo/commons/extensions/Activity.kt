...
import com.maxitendo.commons.databinding.DialogTitleBinding
import com.maxitendo.commons.dialogs.*
import com.maxitendo.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.maxitendo.commons.helpers.*
import com.maxitendo.commons.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import com.maxitendo.commons.helpers.MyContentProvider.MY_CONTENT_URI
import com.maxitendo.commons.models.*
import com.maxitendo.commons.views.MyTextView
import java.io.*
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.maxitendo.gallery" || applicationId == "com.maxitendo.gallery.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null, key: String = "") {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                // Support both com.maxitendo and com.maxitendo package names
                val packageName = when {
                    baseConfig.appId.contains("com.maxitendo.contacts") -> {
                        if (baseConfig.appId.contains(".debug", true)) "com.maxitendo.contacts.debug" else "com.maxitendo.contacts"
                    }
                    baseConfig.appId.contains("com.maxitendo.dialer") -> {
                        if (baseConfig.appId.contains(".debug", true)) "com.maxitendo.dialer.debug" else "com.maxitendo.dialer"
                    }
                    else -> {
                        if (baseConfig.appId.contains(".debug", true)) "com.maxitendo.dialer.debug" else "com.maxitendo.dialer"
                    }
                }
                val className = if (baseConfig.appId.contains("com.maxitendo.contacts")) {
                    "com.maxitendo.contacts.activities.DialerActivity"
                } else {
                    "com.maxitendo.dialer.activities.DialerActivity"
                }
